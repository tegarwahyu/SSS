...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Aug 07, 2020 at 01:20 AM
...
CREATE TABLE IF NOT EXISTS `laravel_logger_activity` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=647 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(642, 'Logged In', 'LaravelLogger::laravel-logger.userTypes.registered', 61, 'http://coba.local/login', '::1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.105 Safari/537.36', 'en-US,en;q=0.9', 'http://coba.local/login', 'POST', '2020-08-05 23:29:25', '2020-08-05 23:29:25', NULL),
(643, 'Logged Out', 'LaravelLogger::laravel-logger.userTypes.registered', 61, 'http://coba.local/logout', '::1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.105 Safari/537.36', 'en-US,en;q=0.9', 'http://coba.local/admin/spt', 'POST', '2020-08-05 23:30:13', '2020-08-05 23:30:13', NULL),
(644, 'Logged In', 'LaravelLogger::laravel-logger.userTypes.registered', 61, 'http://coba.local/login', '::1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.105 Safari/537.36', 'en-US,en;q=0.9', 'http://coba.local/login', 'POST', '2020-08-05 23:30:21', '2020-08-05 23:30:21', NULL),
(645, 'Logged Out', 'LaravelLogger::laravel-logger.userTypes.registered', 61, 'http://www.inspektorat.local/logout', '::1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.105 Safari/537.36', 'en-US,en;q=0.9', 'http://www.inspektorat.local/admin', 'POST', '2020-08-06 00:04:14', '2020-08-06 00:04:14', NULL),
(646, 'Logged In', 'LaravelLogger::laravel-logger.userTypes.registered', 6, 'http://www.inspektorat.local/login', '::1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.105 Safari/537.36', 'en-US,en;q=0.9', 'http://www.inspektorat.local/login', 'POST', '2020-08-06 00:04:19', '2020-08-06 00:04:19', NULL);
